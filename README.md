...
This is a synthetic local harness. The mock agent is deterministic, the policies are simplified, and the scenarios are hand-authored. The optional LLM adapter makes the project easier to extend, but it does not make it validated against real-world payer data or production ready.

See [docs/limitations.md](docs/limitations.md) for a fuller list.
